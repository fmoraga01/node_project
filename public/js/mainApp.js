...
},{"yo-yo":23}],3:[function(require,module,exports){
'use strict';
...
},{"./template":4,"empty-element":9,"page":19,"title":22}],4:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div>\n\t\t\t\t\t<div class="article">\n\t\t\t\t\t\t<h1>Bienvenido Ricardo Este es un ejemplo!!!</h1>\n\t\t\t\t\t\t<p>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno est\xE1ndar de las industrias desde el a\xF1o 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido us\xF3 una galer\xEDa de textos y los mezcl\xF3 de tal manera que logr\xF3 hacer un libro de textos especimen. No s\xF3lo sobrevivi\xF3 500 a\xF1os, sino que tambien ingres\xF3 como texto de relleno en documentos electr\xF3nicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creaci\xF3n de las hojas "Letraset", las cuales contenian pasajes de Lorem Ipsum, y m\xE1s recientemente con software de autoedici\xF3n, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="content-box">\n\t\t\t\t\t\t', '\n\t\t\t\t\t</div>\n\t\t\t\t</div>'], ['<div>\n\t\t\t\t\t<div class="article">\n\t\t\t\t\t\t<h1>Bienvenido Ricardo Este es un ejemplo!!!</h1>\n\t\t\t\t\t\t<p>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno est\xE1ndar de las industrias desde el a\xF1o 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido us\xF3 una galer\xEDa de textos y los mezcl\xF3 de tal manera que logr\xF3 hacer un libro de textos especimen. No s\xF3lo sobrevivi\xF3 500 a\xF1os, sino que tambien ingres\xF3 como texto de relleno en documentos electr\xF3nicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creaci\xF3n de las hojas "Letraset", las cuales contenian pasajes de Lorem Ipsum, y m\xE1s recientemente con software de autoedici\xF3n, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.</>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="content-box">\n\t\t\t\t\t\t', '\n\t\t\t\t\t</div>\n\t\t\t\t</div>']);
...
module.exports = function (pictures) {
	return yo(_templateObject, pictures.map(function (pic) {
		return picture(pic);
	}));
};

},{"../picture-card":6,"yo-yo":23}],5:[function(require,module,exports){
'use strict';
...
},{"./historia":1,"./home":3,"moment":16,"moment/locale/es":15,"page":19}],6:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="card-box">\n\t\t\t\t\t<div class="date">\n\t\t\t\t\t\t<p>Proyecto publicado <span>', '</span></p>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="box-img">\n\t\t\t\t\t\t<img src="', '" width="100%">\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="box-descripcion">\n\t\t\t\t\t\t<h1>', '</h1>\n\t\t\t\t\t\t<p>', '</p>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="box-like ', '">\n\t\t\t\t\t\t<a href="#" class="corazon" onclick=', '></a>\n\t\t\t\t\t\t<a href="#" class="corazon-red" onclick=', '></a>\n\t\t\t\t\t\t<span>', ' Me gusta</span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>'], ['<div class="card-box">\n\t\t\t\t\t<div class="date">\n\t\t\t\t\t\t<p>Proyecto publicado <span>', '</span></p>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="box-img">\n\t\t\t\t\t\t<img src="', '" width="100%">\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="box-descripcion">\n\t\t\t\t\t\t<h1>', '</h1>\n\t\t\t\t\t\t<p>', '</p>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="box-like ', '">\n\t\t\t\t\t\t<a href="#" class="corazon" onclick=', '></a>\n\t\t\t\t\t\t<a href="#" class="corazon-red" onclick=', '></a>\n\t\t\t\t\t\t<span>', ' Me gusta</span>\n\t\t\t\t\t</div>\n\t\t\t\t</div>']);
...
module.exports = function pictureCard(pic) {
	...
	function render(picture) {
		return yo(_templateObject, moment(picture.createdAt).fromNow(), picture.url, picture.nomProyecto, picture.descripcionProyecto, picture.liked ? 'liked' : '', like.bind(null, true), like.bind(null, false), picture.likes);
	}
...
},{"moment":16,"yo-yo":23}],7:[function(require,module,exports){
...
},{"global/document":10,"hyperx":13,"on-load":18}],8:[function(require,module,exports){
...
},{"_process":21,"path-to-regexp":20}],20:[function(require,module,exports){
...
},{"isarray":14}],21:[function(require,module,exports){
...
},{"./update-events.js":24,"bel":7,"morphdom":17}],24:[function(require,module,exports){
module.exports = [
